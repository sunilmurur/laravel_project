...
$common['breadcrumb2']="Edit Customer";
@endphp
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-block">
                                                ...
                                                <form  method="POST" action="{{  route('Customer.update',['id' => $edit_customer->id])  }}" enctype="multipart/form-data">
                                                    @csrf
                                                     @php 
                                                   ...
                                                   <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Customer Name</label>
                                                        ...
                                                        placeholder="Customer Name"  value="{{$edit_customer->customer_name}}">
                                                        @error('customer_name')
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            placeholder="Mobile No"  value="{{$edit_customer->mobile_no}}">
                                                            @error('mobile_no')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="valaya" class="form-control">
                                                                @foreach($res_valaya as $id => $name)
                                                                    <option value="{{ $id }}" <?php if($id == $edit_customer->valaya_id){ echo 'selected'; } ?> >{{ $name }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('valaya')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                        ...
                                                        <label class="col-sm-2 col-form-label">Address</label>
                                                            <div class="col-sm-10">
                                                                    <textarea rows="5" cols="5" class="form-control @error('address') is-invalid @enderror" name="address"
                                                                        placeholder="Address">{{$edit_customer->address}}</textarea>
                                                                        @error('address')
                                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                                        @enderror
                                                            </div>
