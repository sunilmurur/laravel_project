                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-block">
                                                <h4 class="sub-title">Valaya Input</h4>
                                                <form  method="POST" action="{{ route('Valaya.store') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            placeholder="Enter Valaya No"  value="{{ old('valaya_no') }}">
                                                            @error('valaya_no')
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Valaya Name</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control  @error('valaya_name') is-invalid @enderror" name = "valaya_name"
                                                            placeholder="Enter Valaya Name"  value="{{ old('valaya_name') }}">
                                                            @error('valaya_name')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
