...
$common['breadcrumb2']="Add Purchase Sub Category";
@endphp
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-block">
                                                <h4 class="sub-title">Purchase Sub Category Input</h4>
                                                <form  method="POST" action="{{ route('Purchasesubcategory.store') }}" enctype="multipart/form-data">
                                                    @csrf
